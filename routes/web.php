...
Route::get('/course/{id}', 'UserSideController@course')->name('course');
...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
    ...
    Route::get('/', 'StudentQuizzesController@results')->name('home');
    ...
    Route::get('/student/quiz/test/results', ['uses' => 'StudentQuizzesController@index', 'as' => 'student.quizzes']);
    Route::get('/student/quiz/test/results/show/{id}', ['uses' => 'StudentQuizzesController@show', 'as' => 'student.results']);
