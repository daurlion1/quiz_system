...
Route::get('/quizzes', 'QuizzesController@index')->name('quiz');
...
Route::get('/department/delete/{id}',['uses' => 'DepartmentsController@destroy', 'as' => 'department.delete']);
...
Route::get('question_types/delete/{id}',['uses' => 'QuestionTypesController@destroy', 'as' => 'question_type.delete']);

Route::get('/teachers', ['uses' => 'TeachersController@index', 'as' => 'teachers.index']);
Route::get('/teachers/create', ['uses' => 'TeachersController@create', 'as' => 'teachers.create']);
...
Route::get('/teacher/delete/{id}',['uses' => 'TeachersController@destroy', 'as' => 'teacher.delete']);
...
Route::get('/subject/delete/{id}',['uses' => 'SubjectsController@destroy', 'as' => 'subject.delete']);

Route::get('/quizzes', ['uses' => 'QuizzesController@index', 'as' => 'quizzes.index']);
Route::get('/quizzes/create', ['uses' => 'QuizzesController@create', 'as' => 'quizzes.create']);
Route::post('/quizzes/store', ['uses' => 'QuizzesController@store', 'as' => 'quiz.store']);
...
Route::get('/questions/create', ['uses' => 'QuestionsController@create', 'as' => 'questions.create']);
...
Route::get('/question/delete/{id}',['uses' => 'QuestionsController@destroy', 'as' => 'question.delete']);


Route::get('/answers', ['uses' => 'AnswersController@index', 'as' => 'answers.index']);
Route::get('/answers/create', ['uses' => 'AnswersController@create', 'as' => 'answers.create']);
